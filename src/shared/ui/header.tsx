...
function Header({ title, description }: headerPropsType) {
  return (
    <header className="flex w-full max-w-[600px] flex-col items-start justify-between gap-3 border border-red-400 px-5 py-6 pb-0 pr-5">
      <h1 className="m-0 whitespace-pre-line text-title-1">{title}</h1>
